...
def main():
    ...
    print("  • metrics/test_eval_val_dist_loss.png")
    print("  • metrics/test_eval_ema_val_loss.png")
    print("  • metrics/test_eval_val_rmsd.png")
    print("  • metrics/test_stats_val_dist_loss.json")
    print("  • metrics/test_stats_ema_val_loss.json")
    print("  • metrics/test_stats_val_rmsd.json")
    print("\n📈 Comparison Visualizations:")
    print("  • metrics/comparison_overview.png - 2x2 grid overview")
    print("  • metrics/comparison_detailed.png - 3x2 detailed analysis")
    print("  • metrics/comparison_statistical.png - Statistical comparison")
    ...
    print("  • metrics/checkpoint_comparison.json - Test comparison data")
    print("="*70)
